...
const allocate_route_1 = __importDefault(require("./routes/allocate.route"));
...
app.use('/api/v1/allocation', allocate_route_1.default);
app.use('/api/v1/allocated', allocated_route_1.default);
